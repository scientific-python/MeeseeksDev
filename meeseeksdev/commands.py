...
def migrate_issue_request(
    *,
    ...
    migrate_labels = [l for l in original_labels if (l in available_labels and l != "Still Needs Manual Backport")]
    not_set_labels = [l for l in original_labels if (l not in available_labels and l != "Still Needs Manual Backport")]
